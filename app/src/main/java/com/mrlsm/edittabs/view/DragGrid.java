        ...
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (dragPosition != AdapterView.INVALID_POSITION) {
                    ...
                    win_view_x = windowX - dragViewGroup.getLeft();//VIEW相对自己的X，半径
    ...
    public void OnMove(int x, int y) {
        ...
        if (dPosition > 0) {
            ...
            if (dPosition != dragPosition) {
                ...
                float xValue = ((float) mHorizontalSpacing / (float) itemWidth) + 1.0f;
                float yValue = ((float) mVerticalSpacing / (float) itemHeight) + 1.0f;
                Log.d("xValue", "xValue = " + xValue + ",yValue = " + yValue);
