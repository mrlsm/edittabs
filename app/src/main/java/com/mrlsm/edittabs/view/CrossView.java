 ...
 * @since 2019/5/29
 * 对crossView做出对应功能的修改
 * from :https://github.com/cdflynn/crossview
 */
public class CrossView extends View {
    ...
    private static final float ARC_TOP_START = 225f;
    ...
    private static final float ARC_LEFT_ANGLE = 225f;
    private static final float ARC_RIGHT_START = 135f;
    private static final float ARC_RIGHT_ANGLE = 225f;
    ...
    static class CrossViewState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<CrossViewState> CREATOR = new Parcelable.Creator<CrossViewState>() {
